...
TOOLS: dict = {
    ...
    "pneumatic_jack":  {"name":"🏗️ Pneumatic Jackhammer","emoji":"🏗️","tier":4,"tier_name":"Expert",   "price":3000000,      "power":45,   "energy_cost":18,"speed_mult":2.2,  "speed_delay":3, "crit_bonus":0.09,"luck_bonus":0.05,"xp_bonus":1.0,"kg_bonus":1.5,  "description":"Mengguncang tanah!",                        "flavor":"Angin bertekanan 200 PSI.",           "level_req":1,"special":None,"ore_req":{}},
    ...
    "meteor_hammer":   {"name":"☄️ Meteor Hammer",         "emoji":"☄️", "tier":4,"tier_name":"Expert",   "price":30000000,     "power":145,  "energy_cost":22,"speed_mult":3.0,  "speed_delay":3, "crit_bonus":0.12,"luck_bonus":0.09,"xp_bonus":1.0,"kg_bonus":1.85, "description":"Ditempa dari meteor!",                      "flavor":"Logam meteorit besi-nikel.",          "level_req":1,"special":None,"ore_req":{}},
    ...
    "storm_pick":      {"name":"⛈️ Storm Pickaxe",         "emoji":"⛈️","tier":4,"tier_name":"Expert",   "price":55000000,     "power":175,  "energy_cost":23,"speed_mult":3.15, "speed_delay":3, "crit_bonus":0.13,"luck_bonus":0.10,"xp_bonus":1.0,"kg_bonus":1.92, "description":"Diperkuat petir badai!",                    "flavor":"Disambar petir 10.000 volt.",         "level_req":1,"special":None,"ore_req":{}},
    ...
    "neutron_drill":   {"name":"⚛️ Neutron Drill",        "emoji":"⚛️","tier":5,"tier_name":"Master",   "price":200000000,    "power":320,  "energy_cost":27,"speed_mult":3.3,  "speed_delay":2, "crit_bonus":0.15,"luck_bonus":0.12,"xp_bonus":1.0,"kg_bonus":2.35, "description":"Partikel neutron!",                         "flavor":"Reaktor nuklir mini terkontrol.",     "level_req":1,"special":None,"ore_req":{}},
...
ORES: dict = {
    ...
    # UNCOMMON
    "iron":             {"name":"⚙️ Bijih Besi",           "emoji":"⚙️","value":2,          "rarity":12.0,     "xp":1,        "kg_min":0.6,    "kg_max":1800.0,   "desc":"Bijih besi abu-abu, bahan dasar industri.",                     "tier":"uncommon"},
    ...
    "ruby":             {"name":"❤️ Rubi",                    "emoji":"❤️","value":500,       "rarity":1.0,      "xp":40,       "kg_min":0.6,    "kg_max":2100.0,   "desc":"Rubi merah membara, batu mulia paling berharga.",                "tier":"epic"},
    ...
    "cursed_gem":       {"name":"👁️ Batu Terkutuk",          "emoji":"👁️","value":300000,    "rarity":0.002,    "xp":12500,    "kg_min":0.15,    "kg_max":900.0,   "desc":"Batu berisi kutukan kuno.",                                      "tier":"mythical"},
    ...
    "gamma_crystal":    {"name":"☢️ Kristal Gamma",           "emoji":"☢️","value":1750000,   "rarity":0.0004,   "xp":60000,   "kg_min":0.03,    "kg_max":300.0,   "desc":"Kristal teriradiasi sinar gamma dari magnetar.",                 "tier":"cosmic"},
    ...
    "eternity_stone":   {"name":"♾️ Batu Keabadian",          "emoji":"♾️","value":12500000,  "rarity":0.00005,  "xp":500000,  "kg_min":0.3,    "kg_max":1500.0,   "desc":"Ada sejak sebelum alam semesta terbentuk.",                      "tier":"divine"},
    ...
    "creation_spark":   {"name":"✴️ Percikan Penciptaan",     "emoji":"✴️","value":125000000,"rarity":0.000001, "xp":5000000, "kg_min":0.01, "kg_max":3.0,     "desc":"Percikan energi dari momen penciptaan alam semesta.",            "tier":"divine"},
    ...
    "infinity_gem":     {"name":"♾️ Permata Tak Terbatas",    "emoji":"♾️","value":250000000,"rarity":0.0000005,"xp":10000000, "kg_min":0.3,    "kg_max":30000.0, "desc":"Permata yang mengandung kekuatan tak terbatas.",                 "tier":"divine"},
