...
VIP_PRICES = {
    "1_month":  {"label": "1 Bulan",  "price": 25000,  "days": 30},
    "3_months": {"label": "3 Bulan",  "price": 65000,  "days": 90},
    "6_months": {"label": "6 Bulan",  "price": 120000, "days": 180},
    "lifetime": {"label": "Lifetime", "price": 200000, "days": 36500},
}
VIP_TRANSFER_INFO = os.getenv("VIP_TRANSFER_INFO", "Bank BCA: 1234567890 a/n Mining Bot")
TOPUP_TRANSFER_INFO = os.getenv("TOPUP_TRANSFER_INFO", "Bank BCA: 1234567890 a/n Mining Bot")
...
TOOLS: dict = {
    ...
    "laser_cutter":    {"name":"🔬 Laser Cutter Pro",     "emoji":"🔬", "tier":5,"tier_name":"Master",   "price":50000000,     "power":160,  "energy_cost":22,"speed_mult":2.8,  "speed_delay":2, "crit_bonus":0.12,"luck_bonus":0.10,"xp_bonus":1.0,"kg_bonus":2.0,  "description":"Akurasi sempurna.",                         "flavor":"Laser CO₂ 1000W.",                   "level_req":1,"special":"✨ +KG double","ore_req":{}},
    "plasma_drill":    {"name":"🌟 Plasma Drill",          "emoji":"🌟", "tier":5,"tier_name":"Master",   "price":100000000,    "power":250,  "energy_cost":26,"speed_mult":3.2,  "speed_delay":2, "crit_bonus":0.15,"luck_bonus":0.12,"xp_bonus":1.0,"kg_bonus":2.2,  "description":"Mengionisasi batuan!",                      "flavor":"Plasma dari reaktor fusi.",           "level_req":1,"special":"🌟 Plasma Burst: 12% KG 3x","ore_req":{}},
    "neutron_drill":   {"name":"⚛️ Neutron Drill",        "emoji":"⚛️","tier":5,"tier_name":"Master",   "price":150000000,    "power":320,  "energy_cost":27,"speed_mult":3.3,  "speed_delay":2, "crit_bonus":0.15,"luck_bonus":0.12,"xp_bonus":1.0,"kg_bonus":2.35, "description":"Partikel neutron!",                         "flavor":"Reaktor nuklir mini terkontrol.",     "level_req":1,"special":"⚛️ 10% KG 3.5x","ore_req":{}},
    "photon_extractor":{"name":"💡 Photon Extractor",     "emoji":"💡", "tier":5,"tier_name":"Master",   "price":200000000,    "power":400,  "energy_cost":24,"speed_mult":3.5,  "speed_delay":2, "crit_bonus":0.16,"luck_bonus":0.13,"xp_bonus":1.0,"kg_bonus":2.5,  "description":"Ultra-cepat!",                              "flavor":"Foton berenergi tinggi.",             "level_req":1,"special":"💡 Light Speed: 10% skip energy!","ore_req":{}},
    "tachyon_drill":   {"name":"🌀 Tachyon Drill",         "emoji":"🌀", "tier":5,"tier_name":"Master",   "price":280000000,    "power":480,  "energy_cost":25,"speed_mult":3.7,  "speed_delay":2, "crit_bonus":0.16,"luck_bonus":0.135,"xp_bonus":1.0,"kg_bonus":2.65,"description":"Menembus dimensi!",                         "flavor":"Teknologi FTL dari masa depan.",      "level_req":1,"special":"🌀 Tachyon: 12% KG 2x","ore_req":{}},
...
ITEMS: dict = {
    ...
    "weight_enhancer":    {"name":"⚖️ Weight Enhancer",              "emoji":"⚖️","price":28000,     "description":"Ore 2x lebih berat selama 30 menit!",                                  "effect":{"kg_boost":2.0,"duration":30},                   "stackable":True},
