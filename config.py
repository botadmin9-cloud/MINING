...
BAG_SLOT_MAX            = 500
BAG_SLOT_STEP           = 10
BAG_SLOT_BASE_COST      = 50000    # ✅ Lebih mahal (dari 1000), naik berkala
...
ENERGY_UPGRADE_BASE_COST = 50000   # ✅ Lebih mahal (dari 5000), naik berkala
LUCKY_CHANCE             = 0.05
CRITICAL_CHANCE          = 0.10

TOOLS: dict = {
    "stone_pick":      {"name":"⛏️ Beliung Batu",          "emoji":"⛏️",  "tier":1,"tier_name":"Starter",  "price":0,            "power":1,    "energy_cost":10,"speed_mult":1.0,  "speed_delay":6,"crit_bonus":0.00,"luck_bonus":0.00,  "kg_bonus":1.0,  "description":"Beliung batu klasik. Gratis!",                "flavor":"Terbuat dari batu sungai.","level_req":1,  "special":None,"ore_req":{}},
    "wooden_pick":     {"name":"🪵 Beliung Kayu",           "emoji":"🪵",  "tier":1,"tier_name":"Starter",  "price":500,          "power":2,    "energy_cost":10,"speed_mult":1.0,  "speed_delay":6,"crit_bonus":0.01,"luck_bonus":0.0, "kg_bonus":1.02, "description":"Sedikit lebih baik dari batu.",               "flavor":"Kayu oak keras dipahat.","level_req":1,  "special":None,"ore_req":{}},
    "flint_pick":      {"name":"🪨 Beliung Batu Api",        "emoji":"🪨",  "tier":1,"tier_name":"Starter",  "price":2000,         "power":3,    "energy_cost":9, "speed_mult":1.05, "speed_delay":6,"crit_bonus":0.01,"luck_bonus":0.01, "kg_bonus":1.04, "description":"+1% luck. Batu api yang keras.",             "flavor":"Batu api dari tepi sungai.","level_req":1, "special":"🔥 +1% luck","ore_req":{}},
    "copper_pick":     {"name":"🔨 Beliung Tembaga",         "emoji":"🔨",  "tier":2,"tier_name":"Basic",    "price":12000,        "power":3,    "energy_cost":9, "speed_mult":1.1,  "speed_delay":6,"crit_bonus":0.02,"luck_bonus":0.0,  "kg_bonus":1.05, "description":sedikit lebih cepat.",              "flavor":"Dilebur dari bijih tembaga.","level_req":2, "special":None,"ore_req":{}},
    "iron_pick":       {"name":"⚒️ Beliung Besi",           "emoji":"⚒️", "tier":2,"tier_name":"Basic",    "price":35000,        "power":5,    "energy_cost":8, "speed_mult":1.2,  "speed_delay":6,"crit_bonus":0.03,"luck_bonus":0.01,,  "kg_bonus":1.1,  "description":ore lebih berat.",                  "flavor":"Tempa besi kualitas tinggi.","level_req":4, "special":None,"ore_req":{}},
    "bronze_pick":     {"name":"🟫 Beliung Perunggu",        "emoji":"🟫",  "tier":2,"tier_name":"Basic",    "price":60000,        "power":7,    "energy_cost":8, "speed_mult":1.25, "speed_delay":6,"crit_bonus":0.03,"luck_bonus":0.01, "kg_bonus":1.12, "description":alloy tembaga-timah.",              "flavor":"Perunggu dipakai sejak 3000 SM.","level_req":5,"special":None,"ore_req":{}},
    "silver_pick":     {"name":"🥈 Beliung Perak",           "emoji":"🥈",  "tier":2,"tier_name":"Basic",    "price":90000,        "power":8,    "energy_cost":8, "speed_mult":1.3,  "speed_delay":6,"crit_bonus":0.04,"luck_bonus":0.02,  "kg_bonus":1.15, "description":"+2% luck",                        "flavor":"Perak murni dipoles halus.","level_req":6, "special":"🍀 +2% luck","ore_req":{}},
    "gold_pick":       {"name":"🥇 Beliung Emas",            "emoji":"🥇",  "tier":2,"tier_name":"Basic",    "price":180000,       "power":12,   "energy_cost":9, "speed_mult":1.4,  "speed_delay":6,"crit_bonus":0.05,"luck_bonus":0.03,  "kg_bonus":1.2,  "description":crit +5%.",                        "flavor":"Emas solid dengan gagang oak.","level_req":8,"special":"✨ +5% crit","ore_req":{}},
    "alloy_pick":      {"name":"🔩 Beliung Alloy",           "emoji":"🔩",  "tier":2,"tier_name":"Basic",    "price":250000,       "power":14,   "energy_cost":8, "speed_mult":1.45, "speed_delay":6,"crit_bonus":0.05,"luck_bonus":0.03, "kg_bonus":1.22, "description":alloy logam campuran.",             "flavor":"Nikel, kobalt, mangan campuran.","level_req":9,"special":None,"ore_req":{}},
    "steel_drill":     {"name":"🔩 Bor Baja",                "emoji":"🔩",  "tier":3,"tier_name":"Advanced", "price":350000,       "power":15,   "energy_cost":12,"speed_mult":1.5,  "speed_delay":6,"crit_bonus":0.05,"luck_bonus":0.02,  "kg_bonus":1.25, "description":menembus batuan keras.",            "flavor":"Mekanisme gigi roda pertama.","level_req":10,"special":None,"ore_req":{}},
    "electric_drill":  {"name":"⚡ Bor Listrik",              "emoji":"⚡",  "tier":3,"tier_name":"Advanced", "price":700000,       "power":20,   "energy_cost":14,"speed_mult":1.8,  "speed_delay":5,"crit_bonus":0.06,"luck_bonus":0.03,  "kg_bonus":1.3,  "description":kecepatan meningkat!",              "flavor":"Motor 500W torsi luar biasa.","level_req":12,"special":"⚡ 8% chance Double XP!","ore_req":{}},
    "pneumatic_drill": {"name":"💨 Bor Pneumatik",            "emoji":"💨",  "tier":3,"tier_name":"Advanced", "price":900000,       "power":24,   "energy_cost":13,"speed_mult":1.9,  "speed_delay":5,"crit_bonus":0.06,"luck_bonus":0.03,  "kg_bonus":1.32, "description":tekanan angin tinggi.",             "flavor":"Kompresor 150 PSI bertekanan.","level_req":13,"special":"💨 +8% rare ore","ore_req":{}},
    "sonic_drill":     {"name":"🔊 Sonic Drill",              "emoji":"🔊",  "tier":3,"tier_name":"Advanced", "price":1200000,      "power":28,   "energy_cost":13,"speed_mult":2.0,  "speed_delay":5,"crit_bonus":0.07,"luck_bonus":0.04,  "kg_bonus":1.35, "description":gelombang sonik!",                   "flavor":"Frekuensi 50kHz hancurkan batu.","level_req":15,"special":"🔊 Sonic Boom: 5% +3x XP!","ore_req":{}},
    "crystal_drill":   {"name":"🔷 Crystal Drill",            "emoji":"🔷",  "tier":3,"tier_name":"Advanced", "price":2000000,      "power":35,   "energy_cost":14,"speed_mult":2.1,  "speed_delay":5,"crit_bonus":0.08,"luck_bonus":0.05,  "kg_bonus":1.4,  "description":efisien untuk kristal.",           "flavor":"Kuarsa dipotong presisi laser.","level_req":17,"special":"💎 +15% XP kristal","ore_req":{}},
    "magma_drill":     {"name":"🌋 Magma Drill",              "emoji":"🌋",  "tier":3,"tier_name":"Advanced", "price":2500000,      "power":40,   "energy_cost":15,"speed_mult":2.15, "speed_delay":5,"crit_bonus":0.08,"luck_bonus":0.05,  "kg_bonus":1.42, "description":tahan panas lava.",                "flavor":"Alloy tungsten tahan 3000°C.","level_req":19,"special":"🌋 +20% bonus lava zone","ore_req":{}},
    "pneumatic_jack":  {"name":"🏗️ Pneumatic Jackhammer",    "emoji":"🏗️", "tier":4,"tier_name":"Expert",   "price":3000000,      "power":45,   "energy_cost":18,"speed_mult":2.2,  "speed_delay":5,"crit_bonus":0.09,"luck_bonus":0.05,  "kg_bonus":1.5,  "description":mengguncang tanah!",               "flavor":"Angin bertekanan 200 PSI.","level_req":18,"special":"💥 Crit +15%","ore_req":{}},
    "diamond_drill":   {"name":"💠 Diamond Drill",            "emoji":"💠",  "tier":4,"tier_name":"Expert",   "price":6000000,      "power":70,   "energy_cost":20,"speed_mult":2.5,  "speed_delay":5,"crit_bonus":0.10,"luck_bonus":0.07,  "kg_bonus":1.6,  "description":menembus apapun!",                   "flavor":"Berlian industri grade-A.","level_req":22,"special":"🔮 +7% rare ore","ore_req":{}},
    "titanium_drill":  {"name":"🔷 Titanium Drill Pro",       "emoji":"🔷",  "tier":4,"tier_name":"Expert",   "price":12000000,     "power":100,  "energy_cost":19,"speed_mult":2.7,  "speed_delay":5,"crit_bonus":0.11,"luck_bonus":0.08,  "kg_bonus":1.7,  "description":lebih kuat dari berlian!",         "flavor":"Titanium aerospace campuran.","level_req":27,"special":"🔷 +10% crit","ore_req":{}},
    "cobalt_drill":    {"name":"🔵 Cobalt Drill",             "emoji":"🔵",  "tier":4,"tier_name":"Expert",   "price":18000000,     "power":115,  "energy_cost":20,"speed_mult":2.8,  "speed_delay":5,"crit_bonus":0.115,"luck_bonus":0.08,"kg_bonus":1.75, "description":kobalt super keras!",              "flavor":"Kobalt grade militer.","level_req":29,"special":"🔵 +12% crit, KG +5%","ore_req":{}},
    "obsidian_breaker":{"name":"🌑 Obsidian Breaker",         "emoji":"🌑",  "tier":4,"tier_name":"Expert",   "price":22000000,     "power":130,  "energy_cost":22,"speed_mult":2.9,  "speed_delay":5, "crit_bonus":0.12,"luck_bonus":0.09,  "kg_bonus":1.8,  "description":ideal untuk zona lava!",             "flavor":"Alloy karbida tahan 2000°C.","level_req":30,"special":"🌋 +20% XP lava","ore_req":{}},
    "meteor_hammer":   {"name":"☄️ Meteor Hammer",            "emoji":"☄️",  "tier":4,"tier_name":"Expert",   "price":30000000,     "power":145,  "energy_cost":22,"speed_mult":3.0,  "speed_delay":5, "crit_bonus":0.12,"luck_bonus":0.09,  "kg_bonus":1.85, "description":ditempa dari meteor!",            "flavor":"Logam meteorit besi-nikel.","level_req":32,"special":"☄️ +12% crit, +9% luck","ore_req":{}},
    "laser_cutter":    {"name":"🔬 Laser Cutter Pro",         "emoji":"🔬",  "tier":5,"tier_name":"Master",   "price":50000000,     "power":160,  "energy_cost":22,"speed_mult":2.8,  "speed_delay":4, "crit_bonus":0.12,"luck_bonus":0.10,  "kg_bonus":2.0,  "description":akurasi sempurna.",                "flavor":"Laser CO₂ 1000W.","level_req":33,"special":"✨ +10% XP","ore_req":{}},
    "plasma_drill":    {"name":"🌟 Plasma Drill",              "emoji":"🌟",  "tier":5,"tier_name":"Master",   "price":100000000,    "power":250,  "energy_cost":26,"speed_mult":3.2,  "speed_delay":4, "crit_bonus":0.15,"luck_bonus":0.12,  "kg_bonus":2.2,  "description":mengionisasi batuan!",               "flavor":"Plasma dari reaktor fusi.","level_req":40,"special":"🌟 Plasma Burst: 12% +3x XP","ore_req":{}},
    "neutron_drill":   {"name":"⚛️ Neutron Drill",            "emoji":"⚛️", "tier":5,"tier_name":"Master",   "price":150000000,    "power":320,  "energy_cost":27,"speed_mult":3.3,  "speed_delay":4, "crit_bonus":0.15,"luck_bonus":0.12,  "kg_bonus":2.35, "description":partikel neutron!",               "flavor":"Reaktor nuklir mini terkontrol.","level_req":43,"special":"⚛️ 10% +3.5x XP","ore_req":{}},
    "photon_extractor":{"name":"💡 Photon Extractor",         "emoji":"💡",  "tier":5,"tier_name":"Master",   "price":200000000,    "power":400,  "energy_cost":24,"speed_mult":3.5,  "speed_delay":4, "crit_bonus":0.16,"luck_bonus":0.13,  "kg_bonus":2.5,  "description":Ultra-cepat!",                       "flavor":"Foton berenergi tinggi.","level_req":47,"special":"💡 Light Speed: 10% skip energy!","ore_req":{}},
    "tachyon_drill":   {"name":"🌀 Tachyon Drill",            "emoji":"🌀",  "tier":5,"tier_name":"Master",   "price":280000000,    "power":480,  "energy_cost":25,"speed_mult":3.7,  "speed_delay":4, "crit_bonus":0.16,"luck_bonus":0.135, "kg_bonus":2.65, "description":menembus dimensi!",                "flavor":"Teknologi FTL dari masa depan.","level_req":50,"special":"🌀 Tachyon: 12% +4x XP & KG 1.5x","ore_req":{}},
    "nano_extractor":  {"name":"🧬 Nano Extractor",           "emoji":"🧬",  "tier":5,"tier_name":"Master",   "price":350000000,    "power":500,  "energy_cost":25,"speed_mult":3.8,  "speed_delay":4, "crit_bonus":0.17,"luck_bonus":0.14,  "kg_bonus":2.8,  "description":presisi tingkat atom!",              "flavor":"Robot nano 10nm menggali.","level_req":52,"special":"🧬 Nano Swarm: 15% +4x XP!","ore_req":{}},
    "psionic_drill":   {"name":"🧠 Psionic Drill",            "emoji":"🧠",  "tier":5,"tier_name":"Master",   "price":450000000,    "power":580,  "energy_cost":26,"speed_mult":3.9,  "speed_delay":4, "crit_bonus":0.17,"luck_bonus":0.14,  "kg_bonus":2.9,  "description":dikendalikan pikiran!",            "flavor":"Antarmuka neural militer.","level_req":55,"special":"🧠 Psionic: 12% +4x XP & luck","ore_req":{}},
    "quantum_miner":   {"name":"💎 Quantum Miner X",          "emoji":"💎",  "tier":6,"tier_name":"Legendary","price":600000000,    "power":700,  "energy_cost":30,"speed_mult":4.0,  "speed_delay":4, "crit_bonus":0.18,"luck_bonus":0.15,  "kg_bonus":3.0,  "description":manipulasi quantum!",                "flavor":"Superposisi kuantum multi-dim.","level_req":58,"special":"🌀 Quantum Shift: 15% 2 ore!","ore_req":{"diamond":50,"amethyst":20}},
    "void_extractor":  {"name":"🕳️ Void Extractor",         "emoji":"🕳️", "tier":6,"tier_name":"Legendary","price":1500000000,   "power":1200, "energy_cost":35,"speed_mult":5.0,  "speed_delay":4, "crit_bonus":0.20,"luck_bonus":0.20, "kg_bonus":3.5,  "description":materi dari dimensi lain!",         "flavor":"Teknologi reruntuhan alien.","level_req":72,"special":"🕳️ Void Pull: 20% double loot!","ore_req":{"mythril":30,"diamond":100,"dragonstone":5}},
    "entropy_drill":   {"name":"🌪️ Entropy Drill",          "emoji":"🌪️", "tier":6,"tier_name":"Legendary","price":2500000000,   "power":1500, "energy_cost":36,"speed_mult":5.2,  "speed_delay":4, "crit_bonus":0.21,"luck_bonus":0.21, "kg_bonus":3.7,  "description":menggunakan entropi semesta!",       "flavor":"Prinsip termodinamika dibalik.","level_req":80,"special":"🌪️ Entropy: 18% +3x XP & KG 2x","ore_req":{"void_shard":5,"dragonstone":8}},
    "dark_matter_drill":{"name":"🌌 Dark Matter Drill",      "emoji":"🌌",  "tier":6,"tier_name":"Legendary","price":4000000000,   "power":2000, "energy_cost":38,"speed_mult":5.5,  "speed_delay":4, "crit_bonus":0.22,"luck_bonus":0.22, "kg_bonus":4.0,  "description":kekuatan tak terbatas!",            "flavor":"Materi gelap belum dimengerti.","level_req":88,"special":"🌌 Dark Energy: 18% triple XP!","ore_req":{"void_shard":10,"stardust":20,"dragonstone":10}},
    "antimatter_borer":{"name":"💥 Antimatter Borer",        "emoji":"💥",  "tier":6,"tier_name":"Legendary","price":6000000000,   "power":2500, "energy_cost":40,"speed_mult":5.8,  "speed_delay":4, "crit_bonus":0.23,"luck_bonus":0.23, "kg_bonus":4.5,  "description":anihilasi batuan instan!",          "flavor":"1mg antimateri=energi bom nuklir.","level_req":95,"special":"💥 Annihilation: 20% quad XP!","ore_req":{"void_shard":20,"nebula_ore":5,"dragonstone":15}},
    "wormhole_drill":  {"name":"🌐 Wormhole Drill",           "emoji":"🌐",  "tier":6,"tier_name":"Legendary","price":10000000000,  "power":3000, "energy_cost":42,"speed_mult":6.0,  "speed_delay":4, "crit_bonus":0.24,"luck_bonus":0.24, "kg_bonus":4.8,  "description":membuka lubang cacing!",            "flavor":"Singularitas mini terkontrol.","level_req":100,"special":"🌐 Wormhole: 20% +4x XP & rare","ore_req":{"cosmic_dust":10,"nebula_ore":10,"void_shard":30}},
    "celestial_hammer":{"name":"☄️ Celestial War Hammer",    "emoji":"☄️",  "tier":7,"tier_name":"Mythical", "price":15000000000,  "power":3500, "energy_cost":40,"speed_mult":6.0,  "speed_delay":3, "crit_bonus":0.25,"luck_bonus":0.25, "kg_bonus":5.0,  "description":kekuatan dewa!",                    "flavor":"Logam bintang neutron, dewa tempa.","level_req":105,"special":"☄️ Meteor Strike: 25% +5x XP!","ore_req":{"void_shard":50,"stardust":30,"cosmic_dust":20,"dragonstone":20}},
    "star_forge":      {"name":"⭐ Star Forge",               "emoji":"⭐",  "tier":7,"tier_name":"Mythical", "price":25000000000,  "power":5000, "energy_cost":45,"speed_mult":7.0,  "speed_delay":3, "crit_bonus":0.27,"luck_bonus":0.27, "kg_bonus":5.5,  "description":ditempa dari inti bintang!",        "flavor":"Suhu inti bintang 15 juta derajat.","level_req":130,"special":"⭐ Star Forge: 25% +6x XP & KG 2x","ore_req":{"stardust":50,"cosmic_dust":30,"nebula_ore":20}},
    "god_hammer":      {"name":"⚡ God's Hammer",            "emoji":"⚡",  "tier":7,"tier_name":"Mythical", "price":50000000000,  "power":7000, "energy_cost":50,"speed_mult":8.0,  "speed_delay":3, "crit_bonus":0.30,"luck_bonus":0.30, "kg_bonus":6.0,  "description":kekuatan tanpa batas!",             "flavor":"Dicuri dari Olimpus oleh titan.","level_req":200,"special":"⚡ Divine Strike: 30% x10 XP!","ore_req":{"void_shard":100,"cosmic_dust":50,"nebula_ore":20,"stardust":50}},
    "eternal_pick":    {"name":"♾️ Eternal Pickaxe",          "emoji":"♾️", "tier":7,"tier_name":"Mythical", "price":80000000000,  "power":9000, "energy_cost":48,"speed_mult":9.0,  "speed_delay":3, "crit_bonus":0.32,"luck_bonus":0.32, "kg_bonus":6.5,  "description":ada sebelum waktu!",                "flavor":"Tidak diketahui pembuatnya.","level_req":250,"special":"♾️ Eternal: 30% +8x XP & KG 3x","ore_req":{"time_crystal":5,"soul_fragment":5,"void_shard":150,"cosmic_dust":75}},
    "genesis_pick":    {"name":"🌅 Genesis Pickaxe",          "emoji":"🌅",  "tier":8,"tier_name":"Divine",   "price":100000000000, "power":12000,"energy_cost":55,"speed_mult":10.0, "speed_delay":2, "crit_bonus":0.35,"luck_bonus":0.35, "kg_bonus":7.0,  "description":dari awal penciptaan!",             "flavor":"Materi Big Bang yang tertinggal.","level_req":300,"special":"🌅 Genesis Burst: 35% XP*15 & KG*2!","ore_req":{"time_crystal":10,"nebula_ore":50,"cosmic_dust":100,"void_shard":200}},
    "omega_drill":     {"name":"🔱 Omega Drill",              "emoji":"🔱",  "tier":8,"tier_name":"Divine",   "price":250000000000, "power":18000,"energy_cost":57,"speed_mult":11.0, "speed_delay":2, "crit_bonus":0.37,"luck_bonus":0.37, "kg_bonus":7.5,  "description":senjata terakhir penambang!",       "flavor":"Diberkati para dewa tambang.","level_req":350,"special":"🔱 Omega: 38% +10x XP & KG 2.5x","ore_req":{"time_crystal":30,"soul_fragment":15,"eternity_stone":5,"void_shard":400}},
    "singularity_drill":{"name":"🌀 Singularity Drill",       "emoji":"🌀",  "tier":8,"tier_name":"Divine",   "price":500000000000, "power":25000,"energy_cost":60,"speed_mult":12.0, "speed_delay":2, "crit_bonus":0.40,"luck_bonus":0.40, "kg_bonus":8.0,  "description":merobek ruang-waktu!",              "flavor":"Bintang neutron terkompresi.","level_req":400,"special":"🌀 Singularity: 40% semua bonus *10!","ore_req":{"time_crystal":50,"soul_fragment":20,"nebula_ore":100,"void_shard":500}},
    "cosmos_hammer":   {"name":"🌌 Cosmos Hammer",            "emoji":"🌌",  "tier":8,"tier_name":"Divine",   "price":1000000000000,"power":40000,"energy_cost":65,"speed_mult":15.0, "speed_delay":2, "crit_bonus":0.45,"luck_bonus":0.45, "kg_bonus":10.0, "description":menghancurkan realitas!",           "flavor":"Palu berisi energi seluruh galaksi.","level_req":450,"special":"🌌 Cosmos: 45% +15x XP & KG 5x","ore_req":{"universe_core":3,"eternity_stone":20,"soul_fragment":50,"time_crystal":100}},
}
...
ACHIEVEMENTS: dict = {
    ...
    "first_rare":        {"name":"🔮 Rare Hunter",           "desc":"Dapatkan ore rare pertama",            "reward":20000},
    "rich_100k":         {"name":"💰 Orang Kaya",            "desc":"Kumpulkan 100.000 koin",               "reward":100000},
    "rich_1m":           {"name":"💎 Jutawan",               "desc":"Kumpulkan 1.000.000 koin",             "reward":1000000},
    "rich_1b":           {"name":"🏦 Miliarder",             "desc":"Kumpulkan 1 Miliar koin",              "reward":100000000},
    "rich_1t":           {"name":"👑 Triliunder",            "desc":"Kumpulkan 1 Triliun koin",             "reward":2500000000},
    "lvl_10":            {"name":"⭐ Bintang 10",            "desc":"Capai Level 10",                       "reward":50000},
    "lvl_50":            {"name":"🌟 Bintang 50",            "desc":"Capai Level 50",                       "reward":500000},
    "lvl_100":           {"name":"💫 Century",               "desc":"Capai Level 100",                      "reward":5000000},
    "lvl_200":           {"name":"🌙 Level 200",             "desc":"Capai Level 200",                      "reward":25000000},
    "lvl_500":           {"name":"☀️ Level 500",             "desc":"Capai Level 500",                      "reward":100000000},
    "void_shard":        {"name":"🌑 Void Seeker",           "desc":"Temukan Void Shard pertama",           "reward":5000000},
    ...
    "market_first":      {"name":"🏪 Pedagang Pertama",      "desc":"Pertama kali jual di market",          "reward":100000},
    "rebirth_1":         {"name":"🔄 Reborn",                "desc":"Lakukan rebirth pertama",              "reward":1000000},
    "cosmic_find":       {"name":"🌠 Cosmic Hunter",         "desc":"Temukan Debu Kosmik",                  "reward":10000000},
    "divine_find":       {"name":"♾️ Divine Hunter",         "desc":"Temukan Batu Keabadian",               "reward":250000000},
    "heavy_miner":       {"name":"🏋️ Heavy Miner",          "desc":"Kumpulkan total 1.000 kg ore",         "reward":2500000},
    "super_heavy":       {"name":"⚓ Super Heavy",           "desc":"Kumpulkan total 10.000 kg ore",        "reward":25000000},
    "kg_master":         {"name":"🌍 KG Master",             "desc":"Kumpulkan total 100.000 kg ore",       "reward":250000000},
    "ton_miner":         {"name":"🏗️ Ton Miner",            "desc":"Kumpulkan total 1.000 ton ore",        "reward":2500000000},
    "mega_ton":          {"name":"⚓ Mega Ton Miner",        "desc":"Kumpulkan total 30.000 ton ore",       "reward":2500000000},
    "all_zones":         {"name":"🗺️ Penjelajah Dunia",      "desc":"Buka semua zona mining",               "reward":50000000},
    "first_mythical":    {"name":"🐉 Mythical Seeker",       "desc":"Temukan ore mythical pertama",         "reward":25000000},
    "first_cosmic":      {"name":"🌌 Cosmic Seeker",         "desc":"Temukan ore cosmic pertama",           "reward":100000000},
    "first_divine":      {"name":"🌈 Divine Seeker",         "desc":"Temukan ore divine pertama",           "reward":500000000},
    ...
    "tool_master":       {"name":"⚒️ Tool Master",           "desc":"Beli 10 alat berbeda",                 "reward":2500000},
    "legendary_find":    {"name":"💎 Legend Hunter",         "desc":"Temukan ore legendary pertama",        "reward":5000000},
    "neutron_miner":     {"name":"⚪ Neutron Miner",         "desc":"Temukan Inti Neutron",                 "reward":250000000},
    "infinity_hunter":   {"name":"♾️ Infinity Hunter",       "desc":"Temukan Permata Tak Terbatas",         "reward":2500000000},
}
...
TIER_COLORS = {1:"⚪️",2:"🟢",3:"🔵",4:"🟠",5:"❤️",6:"💜",7:"🌟",8:"🌈"}
ORE_TIER_COLORS = {"common":"⚪️","uncommon":"🟢","rare":"🔵","epic":"🟠","legendary":"❤️","mythical":"💜","cosmic":"🌟","divine":"🌈"}
